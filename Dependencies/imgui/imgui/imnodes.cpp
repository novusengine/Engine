...
void StyleColorsDark(ImNodesStyle* dest)
{
    ...
    dest->Colors[ImNodesCol_TitleBarHighlighted] = IM_COL32(250, 150, 66, 255);
...
void StyleColorsClassic(ImNodesStyle* dest)
{
    ...
    dest->Colors[ImNodesCol_TitleBarHighlighted] = IM_COL32(161, 82, 82, 255);
...
void StyleColorsLight(ImNodesStyle* dest)
{
    ...
    dest->Colors[ImNodesCol_TitleBarHighlighted] = IM_COL32(255, 209, 209, 255);
...
void BeginNode(const int node_id, bool highlighted)
{
    ...
    if (highlighted)
    {
        node.ColorStyle.Titlebar = GImNodes->Style.Colors[ImNodesCol_TitleBarHighlighted];
        node.ColorStyle.TitlebarHovered = GImNodes->Style.Colors[ImNodesCol_TitleBarHighlighted];
        node.ColorStyle.TitlebarSelected = GImNodes->Style.Colors[ImNodesCol_TitleBarHighlighted];
    }
    else
    {
