...
namespace Renderer
{
    ...
    public:
        ...
        static void DrawMeshTasks(Renderer* renderer, CommandListID commandList, const void* data);
        static void DrawMeshTasksIndirect(Renderer* renderer, CommandListID commandList, const void* data);
